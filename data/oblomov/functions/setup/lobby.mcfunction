...
setblock -6 43 503 minecraft:oak_wall_sign[facing=south]{Text1:'{"text":"Church, whose ","color":"#FFFFFF"}',Text2:'{"text":"ideals endanger","color":"#FFFFFF"}',Text3:'{"text":"the values of","color":"#FFFFFF"}',Text4:'{"text":"modern world.","color":"#FFFFFF"}'} destroy
...
setblock 2 42 496 minecraft:jungle_wall_sign[facing=north,waterlogged=false]{Text1:'{"text":"Realm of","color":"#0000FF"}',Text2:'{"text":"Oblomov","color":"#0000FF"}'} destroy
...
#credits
setblock -9 43 489 minecraft:oak_wall_sign[facing=east,waterlogged=false]{Text1:'{"text":"Jaquapi","bold":"true","color":"gold"}',Text2:'{"text":"Chief","bold":"true","color":"gold"}',Text3:'{"text":"Programmer","bold":"true","color":"gold"}'} destroy
