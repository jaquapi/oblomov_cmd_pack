...
replaceitem block 2941 5 44 container.9 minecraft:iron_sword{Enchantments:[{id:"minecraft:fire_aspect",lvl:1}],display:{Name:'{"text":"Pressure"}',Lore:['{"text":"Efficient, even against"}','{"text":"the most reluctant workers."}']}} 1
