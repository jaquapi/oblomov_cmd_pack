...
setblock 2899 55 13 minecraft:birch_wall_sign[facing=south,waterlogged=false]{Text1:'{"text":"Shrine of Ictidicti","color":"dark_purple"}',Text2:'{"text":"------"}',Text3:'{"text":"God of Frenzy","color":"dark_purple"}'} destroy
setblock 2896 55 14 minecraft:birch_wall_sign[facing=south,waterlogged=false]{Text1:'{"text":"Shrine of Adelza","color":"aqua"}',Text2:'{"text":"------"}',Text3:'{"text":"Goddess of ","color":"aqua"}',Text4:'{"text":"Wisdom","color":"aqua"}'} destroy
setblock 2896 55 20 minecraft:birch_wall_sign[facing=north,waterlogged=false]{Text1:'{"text":"Shrine of ","color":"green"}',Text2:'{"text":"Olonoloil","color":"green"}',Text3:'{"text":"------"}',Text4:'{"text":"God of Angst","color":"green"}'} destroy
setblock 2899 55 21 minecraft:birch_wall_sign[facing=north,waterlogged=false]{Text1:'{"text":"Shrine of Zarack","color":"white"}',Text2:'{"text":"------"}',Text3:'{"text":"Goddess of ","color":"white"}',Text4:'{"text":"Endurance","color":"white"}'} destroy
setblock 2902 55 20 minecraft:birch_wall_sign[facing=north,waterlogged=false]{Text1:'{"text":"Shrine of Knil","color":"red"}',Text2:'{"text":"------"}',Text3:'{"text":"God of ","color":"red"}',Text4:'{"text":"Courage","color":"red"}'} destroy
...
setblock 2997 89 -49 minecraft:acacia_wall_sign[facing=east,waterlogged=false]{Text1:'{"text":"\'\'A golden "}',Text2:'{"text":"Stain on a "}',Text3:'{"text":"blank Frame\'\'"}',Text4:'{"text":"Work in progress"}'} destroy
setblock 3002 89 -44 minecraft:acacia_wall_sign[facing=north,waterlogged=false]{Text1:'{"text":"\'\'Diamonds\'\'"}',Text2:'{"text":""}',Text3:'{"text":""}',Text4:'{"text":"Work in progress"}'} destroy
setblock 3006 85 -51 minecraft:acacia_wall_sign[facing=west,waterlogged=false]{Text1:'{"text":"\'\'The most famous"}',Text2:'{"text":"Carrot in "}',Text3:'{"text":"the World\'\'"}',Text4:'{"text":"Work in progress"}'} destroy
setblock 3006 85 -47 minecraft:acacia_wall_sign[facing=west,waterlogged=false]{Text1:'{"text":"\'\'To be or not"}',Text2:'{"text":"to be (born)\'\'"}',Text3:'{"text":"An existential"}',Text4:'{"text":"piece"}'} destroy
setblock 3000 85 -45 minecraft:acacia_wall_sign[facing=north,waterlogged=false]{Text1:'{"text":"\'\'The Human "}',Text2:'{"text":"Condition\'\' or "}',Text3:'{"text":"\'\'Dummy\'\'"}',Text4:'{"text":"Debatable title"}'} destroy
setblock 2998 85 -47 minecraft:acacia_wall_sign[facing=east,waterlogged=false]{Text1:'{"text":"\'\'Wanderlust\'\'"}',Text2:'{"text":"(found in the"}',Text3:'{"text":"nature)"}',Text4:'{"text":"Work in progress"}'} destroy
setblock 2998 85 -51 minecraft:acacia_wall_sign[facing=east,waterlogged=false]{Text1:'{"text":"\'\'Emergency"}',Text2:'{"text":"Exit\'\'"}',Text3:'{"text":""}',Text4:'{"text":"Work in progress"}'} destroy
setblock 3000 85 -53 minecraft:acacia_wall_sign[facing=south,waterlogged=false]{Text1:'{"text":"\'\'Vanity 158\'\'"}',Text2:'{"text":"(Real skull on"}',Text3:'{"text":"a cardboard)"}',Text4:'{"text":"Work in progress"}'} destroy
setblock 3004 85 -53 minecraft:acacia_wall_sign[facing=south,waterlogged=false]{Text1:'{"text":"\'\'Still Life 12\'\'"}',Text2:'{"text":""}',Text3:'{"text":""}',Text4:'{"text":"Work in progress"}'} destroy
setblock 3002 85 -50 minecraft:acacia_wall_sign[facing=north,waterlogged=false]{Text1:'{"text":"\'\'Pile of"}',Text2:'{"text":"shining Rocks\'\'"}',Text3:'{"text":""}',Text4:'{"text":"Work in progress"}'} destroy
...
#anti
# give @p minecraft:shield{display:{Name:'{"text":"Aegis of Knil"}',Lore:['{"text":"This shield is certainly far more "}','{"text":"courageous than you are. "}','{"text":"No point in trying to be a hero, "}','{"text":"you can simply hide yourself behind it."}']},Unbreakable:1b}
# give @p minecraft:golden_sword{display:{Name:'{"text":"Holy Sword of Adelza"}',Lore:['{"text":"This antique ornamental sword has been "}','{"text":"teached by Adelza herself. She’d be able "}','{"text":"to take matters in its own swordy hands "}','{"text":"if you happened to lose all your sanity."}']},Unbreakable:1} 1
# give @p minecraft:golden_axe{Unbreakable:1b,display:{Name:'{"text":"Battle Axe of Olonoloil"}',Lore:['{"text":"This weapon is a true burden which feeds "}','{"text":"on its victims’ cry of agony and feasts "}','{"text":"on your anxieties. It will try by any means "}','{"text":"to make you doubt yourself."}','{"text":"Basically, it is no good company at all."}','{"text":"Just leave it where you’ve found it."}']}}
# give @p minecraft:bow{Unbreakable:1b,display:{Name:'{"text":"Great Bow of Ictidicti"}',Lore:['{"text":"Shooting with this bow is such  "}','{"text":"an enjoyable activity that you "}','{"text":"may no longer be able to stop "}','{"text":"doing it even after your death. "}','{"text":"Thus, you’d be a skeleton with a bow."}']}}
# give @p minecraft:golden_chestplate{Unbreakable:1b,display:{Name:'{"text":"Breastplate of Zarachk"}',Lore:['{"text":"This armor is like a second skin, "}','{"text":"nicer, smoother, softer and that won’t "}','{"text":"make you spend a fortune on moisturizer "}','{"text":"and sunscreen."}']}}
# give @p minecraft:totem_of_undying{display:{Name:'{"text":"Sacrificial Effigy of Undyline"}',Lore:['{"text":"You could be tempted to make fun of this "}','{"text":"odd statuette of doubtful artistic value."}','{"text":"But this effigy is prepared to sacrifice "}','{"text":"itself for the sake of you; which makes it "}','{"text":"your only authentic friend. "}']}}
replaceitem block 2941 5 47 container.0 minecraft:shield{display:{Name:'{"text":"Aegis of Knil"}',Lore:['{"text":"This shield is certainly far more "}','{"text":"courageous than you are. "}','{"text":"No point in trying to be a hero, "}','{"text":"you can simply hide yourself behind it."}']},Unbreakable:1b}
