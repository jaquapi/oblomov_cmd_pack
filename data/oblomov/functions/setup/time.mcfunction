...
replaceitem block 788 148 505 container.0 minecraft:beetroot_seeds{display:{Name:'{"text":"Mysterious Seed"}',Lore:['{"text":"Notice : Rich soil needed."}','{"text":"Grows well in the outside."}']}}
...
replaceitem block 776 157 520 container.0 minecraft:paper{display:{Name:'{"text":"Lost Task #951"}',Lore:['{"text":"More work?"}']}}
replaceitem block 775 157 520 container.0 minecraft:paper{display:{Name:'{"text":"Lost Task #601"}',Lore:['{"text":"More work?"}']}}
replaceitem block 774 157 520 container.0 minecraft:paper{display:{Name:'{"text":"Lost Task #669"}',Lore:['{"text":"More work?"}']}}
replaceitem block 773 157 520 container.0 minecraft:paper{display:{Name:'{"text":"Lost Task #300"}',Lore:['{"text":"More work?"}']}}
replaceitem block 772 157 520 container.0 minecraft:paper{display:{Name:'{"text":"Lost Task #820"}',Lore:['{"text":"More work?"}']}}
replaceitem block 771 157 520 container.0 minecraft:paper{display:{Name:'{"text":"Lost Task #174"}',Lore:['{"text":"More work?"}']}}

replaceitem block 771 153 520 container.0 minecraft:paper{display:{Name:'{"text":"Lost Task #951"}',Lore:['{"text":"More work?"}']}}
replaceitem block 772 153 520 container.0 minecraft:paper{display:{Name:'{"text":"Lost Task #601"}',Lore:['{"text":"More work?"}']}}
replaceitem block 773 153 520 container.0 minecraft:paper{display:{Name:'{"text":"Lost Task #669"}',Lore:['{"text":"More work?"}']}}
replaceitem block 774 153 520 container.0 minecraft:paper{display:{Name:'{"text":"Lost Task #300"}',Lore:['{"text":"More work?"}']}}
replaceitem block 775 153 520 container.0 minecraft:paper{display:{Name:'{"text":"Lost Task #820"}',Lore:['{"text":"More work?"}']}}
replaceitem block 776 153 520 container.0 minecraft:paper{display:{Name:'{"text":"Lost Task #174"}',Lore:['{"text":"More work?"}']}}
...
setblock 507 120 493 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Text1:'{"text":"The Altar of"}',Text2:'{"text":"the Divine"}',Text3:'{"text":"Ordinator"}',Text4:'{"text":""}'} destroy

setblock 506 120 493 minecraft:oak_wall_sign[facing=south,waterlogged=false]{Text1:'{"text":"Prayer to the"}',Text2:'{"text":"Divine"}',Text3:'{"text":"Ordinator"}',Text4:'{"text":""}'} destroy
...
#FUTURE
#0F
setblock -494 150 508 minecraft:birch_wall_sign[facing=south,waterlogged=false]{Text1:'{"text":"Year"}',Text2:'{"text":"633 A.M."}',Text3:'{"text":""}',Text4:'{"text":""}'} destroy
...
setblock -532 138 492 minecraft:jungle_wall_sign[facing=east,waterlogged=false]{Color:"black",Text4:'{"text":""}',Text3:'{"text":""}',Text2:'{"extra":[{"text":"for rare plants"}],"text":""}',Text1:'{"extra":[{"text":"INCUBATOR"}],"text":""}'}
