...
setblock 255 61 93 minecraft:spruce_wall_sign[facing=south,waterlogged=false]{Text1:'{"text":"Please use the","color":"black"}',Text2:'{"text":"ashtray when","color":"black"}',Text3:'{"text":"you\'re smoking","color":"black"}',Text4:'{"text":"here.","color":"black"}'} destroy
...
#BONUS CHESTS
replaceitem block 222 5 129 container.0 minecraft:sunflower{display:{Name:'{"text":"Shining sunflower"}',Lore:['{"text":"(Evidence) You feel good seeing"}','{"text":"this enormous flower, as if all "}','{"text":"the corruption of the world vanished."}']}}
